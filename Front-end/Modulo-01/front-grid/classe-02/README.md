...
Utilize o display grid para construir o layout de acordo com o design encontrado no arquivo .fig na raiz do projeto e com o guia-de-estilo encontrado na pasta atual.
...
###### tags: `front-end` `módulo 1` `HTML` `CSS` `exercício de classe`
